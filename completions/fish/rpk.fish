...
complete -c rpk -n "__fish_rpk_using_subcommand help; and not __fish_seen_subcommand_from init list sync add restore update find env completions version help" -f -a "env" -d 'print environment information'
